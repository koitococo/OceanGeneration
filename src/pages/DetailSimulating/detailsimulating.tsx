...
const DetailSimulating: React.FC = () => {
  ...
  const startProgressBar = () => {
    let randomStep = sessionStorage.getItem('debugMode') === 'true' ? () => 114 : Math.random;
    ...
    timerRef.current = setInterval(() => {
      ...
      setPercent((prevPercent) => {
        const newPercent = prevPercent + (isGpuEnabled ? 20 : 3) * randomStep();
        if (newPercent > 100) {
